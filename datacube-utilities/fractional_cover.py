# copy of dcal dc_fractional_coverage_classifier.py adjusted for sac use- due to differential naming of bands etc. 
...
#csv_file_path = '/odc-hub/utils_dcal/data_cube_utilities/endmembers_landsat.csv'
...
def frac_coverage_classify(dataset_in, clean_mask=None, no_data=-9999):
    ...
    for band in [
            ...
            dataset_in.swir_1.values, dataset_in.swir_2.values
    ]:
    ...
    #dataset_in = dataset_in.rename({"x": "latitude", "y":"longitude"}) # uncomment if coordinates not named latitude and longitude     
